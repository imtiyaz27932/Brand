...
class dashbaord {
    elements = {
        ...
        closenavicon: () => cy.get('.myReact-icons').eq(5),
        helpicon: () => cy.get('.myReact-icons').eq(6),
        notificationicon: () => cy.get('.myReact-icons').eq(7),
        darkmodeicon: () => cy.get('.myReact-icons').eq(8),
        languageicon: () => cy.get('.myReact-icons').eq(9),
        profileicon: () => cy.get('.myReact-icons').eq(10),
    ...
    darkmodetoggle() {
        ...
        this.elements.darkmodeicon().click()
    ...
    useraccount() {
        this.elements.userclicksalreadyhaveanaccount().click()
    }
    ...
    languageswitch() {
        ...
        this.elements.arabiclanguage().click()
        cy.wait(2000)
        this.elements.languageicon().click()
        this.elements.englishlanguage().click()
    }
}
